...
public class ChangeMode2 : MonoBehaviour {
    ...
    void OnClick()
    {
        m_pButton_GameStart.GetComponent<MenuAppear>().Show(1.0f, 2.0f);
        m_pButton_Credit.GetComponent<MenuAppear>().Show(1.0f, 1.6f);
        m_pButton_Option.GetComponent<MenuAppear>().Show(1.0f, 1.2f);
        m_pButton_Exit.GetComponent<MenuAppear>().Show(1.0f, 0.8f);

        m_pButton_Battle.active = true;
        m_pButton_Scenario.active = true;

        m_pButton_Battle.GetComponent<MenuAppear>().Hide(1.0f, 0.0f);
        m_pButton_Scenario.GetComponent<MenuAppear>().Hide(1.0f, 0.4f);


        m_pButton_Back.active = true;

        m_pButton_Back.GetComponent<MenuAppear>().Hide(1.0f, 0.0f);
